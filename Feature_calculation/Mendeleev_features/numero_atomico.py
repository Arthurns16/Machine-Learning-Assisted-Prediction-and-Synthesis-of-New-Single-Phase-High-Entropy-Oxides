...
def vetor_Z_atomos (linha) :
    ...
    for elemento in atomos:
        try: 
            vetor_propriedade_da_linha.append (float(Z(elemento)))
        except:
            valor = 0
